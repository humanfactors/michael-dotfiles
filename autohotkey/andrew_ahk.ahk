...
*/
DHotstring(trigger, label, mode := 1, clearTrigger := 1, cond := ""){
	global $
...
;; If you type \word- it will convert to \word{|} with cursor being at | position

DHotstring("(\\[\w]+)(-)", "replace",3) ;Regex
return
...
;; If you type \word_word2- it will convert to \word{word2}| with cursor being at | position

DHotstring("(\\[\w]+)_([\w]+)(-)", "replace2",3) ;Regex
return
